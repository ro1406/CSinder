...
if __name__ == '__main__':
    ...
    proj1 = Project(name="ML Sample Project",projID="P84282",description="Diam dui tempor augue, mollis condimentum nisi mauris eu mauris.",difficulty=3,user=user1)
    proj2 = Project(name="Programming in Games Project",projID="P93882",description="Morbi mollis magna sit amet mauris rutrum malesuada. ",difficulty=1,user=user2)
    proj3 = Project(name="WoWo Game Design Graphics",projID="P98387",description="Maecenas diam augue, bibendum et commodo ac, convallis sed dui.",difficulty=5,user=user3)
    proj4 = Project(name="Anime Neural Networks",projID="P88772",description="Cras a enim vitae turpis finibus cursus sit amet non risus.",difficulty=2,user=user3)
    proj5 = Project(name="Wonky Networking LMAOO",projID="P56352",description="Curabitur ornare metus ut mauris bibendum vulputate. Maecenas ac condimentum libero.",difficulty=2,user=user2)
    proj6 = Project(name="UML Design for AI",projID="P88372",description="Phasellus dictum maximus nisi, vitae interdum mi volutpat et.",difficulty=4,user=user1)
    proj7 = Project(name="Homework Help?!",projID="P55442",description="enean convallis risus in massa imperdiet mattis.",difficulty=4,user=user4)
